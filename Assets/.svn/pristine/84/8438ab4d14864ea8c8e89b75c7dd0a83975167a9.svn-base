...
{
    public const string wndPath = "Prefab/UI/";
    ...
    public static void Init()
    {
        ...
        var cav = layerMap["Fight"].GetComponent<Canvas>();
    ...
    public static T Get<T>( string name) where T:ViewBase
    {
        
        return wndMap[name] as T;
    }
